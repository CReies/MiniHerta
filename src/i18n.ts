...
export function initializeLocale(): Locale {
  ...
  locale = stored === "en" || stored === "es" ? stored : detectBrowserLocale();
...
export function localeForItemKind(kind: ItemKind): "character" | "lightCone" {
  return kind === "character" ? "character" : "lightCone";
}
